...
urlpatterns = [
    ...
    path('delete_poll_name/<int:pk>/', views.PollDeleteView.as_view(), name ='delete_poll_name'),
    path('create_poll_quiz/<int:poll_id>/', views.CreateQuizView.as_view(), name ='create_poll_quiz'),
    path('edit_questions/<int:pk>/', views.EditQuizView.as_view(), name ='edit_questions'),
    path('delete_question/<int:pk>/', views.QuizDeleteView.as_view(), name ='delete_question'),
